...
## ChipKit I2C
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { IIC_scl_o }];     #IO_L24N_T3_34 Sch=IIC_scl_o
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { IIC_sda_io }];    #IO_L24P_T3_34 Sch=IIC_sda_io
